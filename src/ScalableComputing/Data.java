...
public class Data {
	...
	static ConcurrentHashMap<Integer,PrintStream> writers = new ConcurrentHashMap<Integer,PrintStream>();	//Client ids O/P Stream.
	static ConcurrentHashMap<Integer,Integer> clients = new ConcurrentHashMap<Integer,Integer>();	//Client ID and Chat room Relationship
